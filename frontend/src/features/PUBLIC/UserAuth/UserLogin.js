...
// Non Api User Slice
import { setUserCred } from "./userAuthSlice";
// apiSlice to interact with rest api
import { useUserLoginMutation } from "./userAuthApiSlice";
// Hooks
...
export default function UserLogin() {
  ...
  const onLogInSubmit = async (event) => {
    ...
    try {
      ...
      dispatch(setUserCred({ accessToken, isUser: true }));
  ...
  return (
    ...
    >
      ...
      />
      <CustomLink urlPath="/sign-up">Sign Up</CustomLink>
